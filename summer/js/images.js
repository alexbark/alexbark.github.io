SUMMER.generateSlides = function* (){
  ...
  yield {imgSrc: "summer/img/layers.jpg", text: "taking picture of taking picture", imgWidth: "horiz"};
	...
	yield {imgSrc: "summer/img/prague1.jpg", text: "and Prague again", imgWidth: "vert"};
	yield {imgSrc: "summer/img/prague4.jpg", text: "even more Prague!", imgWidth: "horiz"};
	yield {imgSrc: "summer/img/prague5.jpg", text: "Ooookay, Prague view", imgWidth: "horiz"};
	...
	yield {imgSrc: "summer/img/snail.jpg", text: "..or anywhere at nature", imgWidth: "vert"};
	...
	yield {imgSrc: "summer/img/stupid.jpg", text: "...except that stupid guy", imgWidth: "vert"};
	yield {imgSrc: "summer/img/monk.jpg", text: "or that Shaolin monk", imgWidth: "horiz"};
